...
namespace AfipWS
{
    ...
    public partial class UltimoComprobante : object
    {
        ...
        private AfipWS.Comprobante[] ComprobantesField;
        
        private string ErrorField;
        
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AfipWS.Comprobante[] Comprobantes
        {
            get
            {
    ...
    public partial class SolicitudAutorizacion : object
    {
        ...
        private AfipWS.TipoComprobante TipoComprobanteField;
        
        private AfipWS.TipoDocumento TipoDocumentoField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AfipWS.TipoComprobante TipoComprobante
        {
            get
            {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public AfipWS.TipoDocumento TipoDocumento
        {
            get
            {
    ...
    public partial class ResultadoSolicitudAutorizacion : object
    {
        ...
        private System.Nullable<AfipWS.EstadoSolicitud> EstadoField;
        
        private string FechaDeVencimientoField;
        
        private string ObservacionField;
        
        private System.Nullable<AfipWS.TipoComprobante> TipoComprobanteField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Nullable<AfipWS.EstadoSolicitud> Estado
        {
            get
            {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Nullable<AfipWS.TipoComprobante> TipoComprobante
        {
            get
            {
                return this.TipoComprobanteField;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://ISTP1.Service.Contracts.Service", ConfigurationName="AfipWS.ILoginService")]
    public interface ILoginService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ISTP1.Service.Contracts.Service/ILoginService/SolicitarAutorizacion", ReplyAction="http://ISTP1.Service.Contracts.Service/ILoginService/SolicitarAutorizacionRespons" +
            "e")]
        System.Threading.Tasks.Task<AfipWS.Autorizacion> SolicitarAutorizacionAsync(string codigo);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ISTP1.Service.Contracts.Service/ILoginService/SolicitarUltimosComprobantes" +
            ...
            "Response")]
        System.Threading.Tasks.Task<AfipWS.UltimoComprobante> SolicitarUltimosComprobantesAsync(string token);
        ...
        System.Threading.Tasks.Task<AfipWS.ResultadoSolicitudAutorizacion> SolicitarCaeAsync(string token, AfipWS.SolicitudAutorizacion solicitud);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface ILoginServiceChannel : AfipWS.ILoginService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class LoginServiceClient : System.ServiceModel.ClientBase<AfipWS.ILoginService>, AfipWS.ILoginService
    {
        ...
        public System.Threading.Tasks.Task<AfipWS.Autorizacion> SolicitarAutorizacionAsync(string codigo)
        {
            return base.Channel.SolicitarAutorizacionAsync(codigo);
        }
        
        public System.Threading.Tasks.Task<AfipWS.UltimoComprobante> SolicitarUltimosComprobantesAsync(string token)
        {
            return base.Channel.SolicitarUltimosComprobantesAsync(token);
        }
        
        public System.Threading.Tasks.Task<AfipWS.ResultadoSolicitudAutorizacion> SolicitarCaeAsync(string token, AfipWS.SolicitudAutorizacion solicitud)
        {
